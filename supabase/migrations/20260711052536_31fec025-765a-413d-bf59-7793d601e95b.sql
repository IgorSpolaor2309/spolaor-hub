...
BEGIN
  ...
  VALUES (_label, v_admin) RETURNING id INTO v_batch;
  ...
  -- tax_guides: colunas reais são tipo/competencia/vencimento/valor/status
  ...
  -- notifications: colunas reais são tipo/titulo/mensagem
  ...
  -- timeline_events: colunas reais são tipo/descricao/actor_profile_id/metadata
