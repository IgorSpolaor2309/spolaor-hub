      ...
      <div className="max-w-4xl mx-auto py-8 px-4 space-y-8 animate-in fade-in duration-700">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className={cn("p-6 flex flex-col", !plan ? "bg-purple-600 text-white" : "bg-primary text-primary-foreground")}>
            <h3 className="font-bold text-lg mb-2">{plan ? "Recomendação Comercial" : "Solução Personalizada"}</h3>
            {plan ? (
              <>
              ...
              <div className="flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm opacity-90 leading-relaxed">
                    Sua operação com faturamento de {brl(extractedData?.revenue)} requer uma proposta personalizada e atendimento exclusivo.
                  </p>
                </div>
                <div className="space-y-3 mt-6">
                  <Button 
                    ...
                    onClick={() => {
                      const message = encodeURIComponent(`Olá! Quero trocar de contador. Minha empresa tem faturamento de ${brl(extractedData?.revenue)} e gostaria de uma proposta personalizada.`);
